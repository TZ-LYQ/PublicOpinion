<template>
  ...
  <view class="tabs">
      ...
      <swiper :current="tabIndex" class="swiper-box" style="flex: 1;" :duration="300" @change="ontabchange" type="line">
  						...
  						<view slot="actions" class="card-actions">
  							<view class="media-foot flex-row" style="flex-direction: row;">
  								<view class="media-info flex-row" style="flex-direction: row;">
  									<text class="info-text">{{options.source}}远洋所</text>
  									<text class="info-text">{{options.comment_count}}条评论</text>
  									<text class="info-text">{{options.datetime}}2024-01-23 20:55</text>
  								</view>
...
<script>
	import mediaItem from '../components/opinion-item.nvue';
